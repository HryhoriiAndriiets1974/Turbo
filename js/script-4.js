...
// результат виконання функції makePizza, а у змінній
// pointer було посилання на функцію makePizza.
// function makePizza() {
...
// очікувала другим параметром (параметр callback)
// колбек-функцію і повертала її виклик. Функція
// deliverPizza або makePizza буде передаватися як
// колбек і очікувати аргументом ім'я готової піци,
//  що доставляється.
...
// }
//===============================================---- 3
// Доповни другий виклик функції makePizza(pizzaName,
//  callback), передавши другим аргументом інлайн
// колбек-функцію eatPizza(pizzaName), яка логує рядок
...
// він приймав другим і третім параметром два колбеки
//  onSuccess і onError.
// Якщо у властивості pizzas відсутня піца з назвою з
//  параметра pizzaName, метод order повинен повертати
//  результат виклику колбека onError, передаючи йому
//  аргументом рядок "There is no pizza with a
// name{/* <имя пиццы> in the assortment." */}
// Якщо у властивості pizzas присутня піца з назвою
// з параметра pizzaName, метод order повинен повертати
//  результат виклику колбека onSuccess, передаючи йому
//  аргументом назву замовленої піци.
// Після оголошення об'єкта pizzaPalace ми додали
// колбеки і виклики методів. Будь ласка, нічого там не міняй.
// const pizzaPalace = {
...
// }
//===============================================---- 6
// Функція filterArray(numbers, value) приймає масив чисел
//  numbers і повертає новий масив, в якому будуть тільки
//  ті елементи оригінального масиву, які більші за
...
// firstArray і secondArray, і повертає новий масив
// їхніх спільних елементів, тобто тих, які присутні
//  в обох масивах.
// Виконай рефакторинг функції таким чином, щоб замість
//  циклу for, вона використовувала метод forEach.
...
//   return users.reduce((total, value) => total + value.friends.length, 0);
//  };
//  // Change code above this line
...
// щоб вона повертала масив унікальних імен друзів
...
//===============================================---- 48
// Доповни функцію getTotalBalanceByGender(users, gender)
// таким чином, щоб вона повертала загальний баланс
// користувачів (властивість balance), стать
// яких (властивість gender) збігається зі значенням
// параметра gender.
// // Change code below this line
// const users = [
//   {
